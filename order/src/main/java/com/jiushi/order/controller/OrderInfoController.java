...
public class OrderInfoController {
    ...
    public ResultVO<String> doSeckill(Long seckillId) {
        ...
        RedisScript<Boolean> decreaseStockScript = new DefaultRedisScript<>(decreaseLuaStr, Boolean.class);
        // 秒杀id获取到秒杀商品对象

        // 执行Lua脚本，假设productId作为Key
        Boolean result = redisTemplate.execute(decreaseStockScript, Collections.singletonList("seckill::today:seckill:seckillId:"+seckillId), Integer.toString(1));
